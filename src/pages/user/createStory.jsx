...
const CreateStory = () => {
  ...
  const blob = await response.blob();
    ...
    try {
      ...
      const res1 = await axiosInstance.post('uploadstory',{img:response.data.public_id})
        ...
        <span className="sr-only">Loading...</span>
          ...
          <div className="border h-1/2 sm:w-1/3 rounded-lg w-full">
            <span className="flex justify-center">
              <h4 className="text-white">Create new story</h4>
            </span>
          ...
          document.getElementById('upload-input').click()
            ...
            {selectedImage && (
              <div className="flex flex-col justify-center items-center mt-8">
                ...
                <textarea id="message" style={{display:"none"}} rows="3" className="block mb-3 p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Write your thoughts here..."></textarea>
              ...
              />
                ...
                <button
                  className="bg-blue-500 text-white rounded-md px-2 p-1 text-sm mt-10 font-semibold"
